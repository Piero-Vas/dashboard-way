        ...
        <Table className="border border-default-200">
          <TableHeader>
            <TableRow className="border-b border-default-200">
              <TableHead className="text-sm h-10 font-medium text-default-800">Paises con mayor frecuencia</TableHead>
              <TableHead className="text-sm h-10 font-medium text-default-800 text-right">Usuarios</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {users.map((item) => (

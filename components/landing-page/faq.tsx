          ...
          <div>
            <Accordion type="single" collapsible className="space-y-6" >
              ...
              >
                ...
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  Way itself doesn’t include Figma design files automatically, but we're happy to provide them for free upon request. This allows for flexible customization within Figma.
              ...
              >
                <AccordionTrigger className="text-base xl:text-lg text-left font-medium text-default-900">
                  What skills are needed to use Way?
                </AccordionTrigger>
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  Using Way effectively requires a foundational knowledge of front-end development, particularly with Tailwind and React for deeper customization.
                  It's important to remember that Way is a front-end template;
          ...
          <div>
            <Accordion type="single" collapsible className="space-y-6" >
              ...
              >
                ...
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  The latest Way version can always be downloaded from ThemeForest without any extra charge.
              ...
              >
                <AccordionTrigger className="text-base xl:text-lg text-left font-medium text-default-900">
                  Is Way worth the investment?
                </AccordionTrigger>
                <AccordionContent className="text-sm xl:text-base text-default-700">
                  Absolutely. Way is meticulously crafted to streamline the development process, offering a seamless and efficient way to build your web UI.

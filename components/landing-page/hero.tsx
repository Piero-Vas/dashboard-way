          ...
          <div className=" relative z-10">
            <div className="pt-32 md:pt-48">
              ...
              <div className="flex mt-9 justify-center gap-4 lg:gap-8">
                ...
                <Button asChild variant="outline" size="xl"></Button>
              </div>
            </div>
          </div>
          <Image

...
export const getStatusDriverRequirement = (
  status: StatusRegisterDriver
): string => {
  switch (status) {
    case StatusRegisterDriver.PENDING:
      return "Pendiente";
    case StatusRegisterDriver.ACTIVE:
      return "Aprobado";
    case StatusRegisterDriver.REJECTED:
      return "Rechazado";
    default:
      return "Desconocido";
  }
...
export const getStatusClass = (status: StatusRegisterDriver): string => {
  switch (status) {
    case StatusRegisterDriver.PENDING:
      return "text-status-requirement pending";
    case StatusRegisterDriver.ACTIVE:
      return "text-status-requirement approved";
    case StatusRegisterDriver.REJECTED:
      return "text-status-requirement rejected";
    default:
      return "";
  }
};

export const getIconModalDialog = (action: ActionModalDialog): string => {
  switch (action) {
    case ActionModalDialog.CREATE:
      return "heroicons:plus";
    case ActionModalDialog.EDIT:
